...
import { CheckCircle, Copy, ArrowLeft, ArrowRight, GraduationCap, Briefcase, Scale, Users, Printer, AlertTriangle } from 'lucide-react'
      ...
      <div className="page-container" style={{ maxWidth:'780px', padding:'48px 1.5rem 72px' }}>
        ...
        <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginTop:'24px' }}>
          ...
          <button
            ...
            onClick={goNext}
            disabled={step === 4 && !emailVerified}
            title={step === 4 && !emailVerified ? vb.text : undefined}
          >
            {step === 4 ? (
