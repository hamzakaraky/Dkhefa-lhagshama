  ...
  he: {
    ...
    chat: {
      ...
      system: {
        ...
        closeProposed:      'התבקשה סגירת הבקשה. נא לאשר או לדחות.',
        closeApproved:      'סגירת הבקשה אושרה על ידי צד אחד.',
        closeDeclined:      'בקשת הסגירה נדחתה.',
        closeClosed:        'הבקשה נסגרה בהסכמת שני הצדדים.',
      },
    },
  },
  en: {
    ...
    chat: {
      ...
      system: {
        ...
        closeProposed:      'A request to close was made. Please approve or decline.',
        closeApproved:      'One side approved closing the request.',
        closeDeclined:      'The close request was declined.',
        closeClosed:        'The request was closed by mutual consent.',
      },
    },
  },
} as const
